...
#
# Generated by Vivado on Tue Jan 12 15:53:40 +0800 2021
# SW Build 2960000 on Wed Aug  5 22:57:20 MDT 2020
#
# Copyright 1986-2020 Xilinx, Inc. All Rights Reserved. 
#
# usage: fire.sh [-help]
# usage: fire.sh [-lib_map_path]
# usage: fire.sh [-noclean_files]
# usage: fire.sh [-reset_run]
#
#*********************************************************************************************************
...
# Script info
echo -e "fire.sh - Script generated by export_simulation (Vivado v2020.1.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L blk_mem_gen_v8_4_4 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fire xil_defaultlib.fire xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fire -key {Behavioral:sim_1:Functional:fire} -tclbatch cmd.tcl -log simulate.log
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./fire.sh -help\" for more information)\n"
        exit 1
      fi
     copy_setup_file $2
    ;;
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb fire.wdb xsim.dir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./fire.sh -help\" for more information)\n"
    exit 1
  fi
